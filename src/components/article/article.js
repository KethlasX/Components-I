...
function articleMaker(articleObj) {
  ...
  const articleTitle = document.createElement('hs');
  ...
  articleParaOne.textContent = articleObj.secondParagraph;
  articleParaOne.textContent = articleObj.thirdParagraph;
